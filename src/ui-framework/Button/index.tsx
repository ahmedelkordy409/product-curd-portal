...
const Button = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
  ...
  const rootClassName = cn(
    'group text-[13px] rounded-lg md:text-sm lg:text-15px leading-4 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-body font-semibold text-center justify-center tracking-[0.2px] rounded placeholder-white focus-visible:outline-none focus:outline-none',
    {
